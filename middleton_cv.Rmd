...
tribble(~ Dates, ~ Title, ~ Agency, ~ PIs,
        ...
        "NIH NIDCR",
        "RJ Sherwood and D Duren (Multiple PI) \\\\ \\textbf{Kevin M Middleton} co-I (Lead statistician; 10\\% salary support)",
        
        "2021",
        "R01 - Craniofacial Growth Prediction in Diﬀerent Facial Types",
        "NIH NIDCR",
        "RJ Sherwood and HS Oh (Multiple PI) \\\\ \\textbf{Kevin Middleton} co-I (Lead statisticsian; 10\\% salary support)") %>% 
