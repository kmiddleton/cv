...
tribble(~ Dates, ~ Title, ~ Agency, ~ PIs,
        ...
        "NIH NIDCR",
        "Richard Sherwood (PI), Dana Duren (co-I), Kieran McNulty (co-PI), \\textbf{Kevin Middleton} (Co-PI), Heesoo Oh (co-PI), Manish Valiathan (co-PI).",

        "TBS 2024",
        "R01 - Mechanistic Role of Microstructure on the Mechanical Properties of the Maturing Growth Plate",
        "NIH NIAMS",
        "Dana Duren (PI), \\textbf{Kevin Middleton} (Co-I), Maria Serrat (CO-I), Antonis Stylianou (Co-I)."
) |> 
  detailed_entries(when = Dates,
                   what = Title,
                   with = Agency,
...
University of Missouri only. 33 additional students at CSU San Bernardino, Brown University, and UC Riverside (2003--2012).

```{r, UG_mentoring}
tribble(
  ~ Dates, ~ Name, ~ Notes,
  "2024-Present", "Gabriella Ramirez", "MU Discovery Fellow",
