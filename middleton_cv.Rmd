...
tribble(~ Dates, ~ Title, ~ Agency, ~ PIs,
        ...
        "NIH NIDCR",
        "Richard Sherwood (PI), Dana Duren (PI), \\textbf{Kevin Middleton} (Co-I). (\\$2,555,040)",
        
        "2022",
        "Upgrade of the X-ray tomographic microscope to expand operations at the University of Missouri X-ray Microanalysis Laboratory",
        "NSF",
        "James Schiffbauer (PI), Sarah Jacquet (Co-PI), Casey Holliday (Co-PI), \\textbf{Kevin Middleton} (Co-PI), Tara Selly (Co-PI). (\\$599,996)",
        
        "2022",
        "R01 - Maturation-based modeling of segmental spinal growth",
        "NIH NIAMS",
        "Dana Duren (PI), \\textbf{Kevin Middleton} (Co-I), John Shepherd (CO-I), Babette Zemel (Co-I). (\\$3,053,893)",

        "2023",
        "R01 - Mechanistic Role of Microstructure on the Mechanical Properties of the Maturing Growth Plate",
        "NIH NIAMS",
        "Dana Duren (PI), \\textbf{Kevin Middleton} (Co-I), Maria Serrat (CO-I), Antonis Stylianou (Co-I). (\\$1,689,908)",

         "2023",
        "R01 - Evidence-based optimization of treatment timing in the craniofacial complex",
        "NIH NIDCR",
        "Richard Sherwood (PI), Dana Duren (co-I), Kieran McNulty (co-PI), \\textbf{Kevin Middleton} (Co-PI), Heesoo Oh (co-PI), Manish Valiathan (co-PI). (\\$3,487,078)"
...
tribble(~ Dates, ~ Title, ~ Agency, ~ PIs,
        "TBS 2023",
        "Functional morphology of the mammal hand and foot using contrast-enhanced 3D imaging",
        "NSF",
        "Casey Holliday (co-PI), \\textbf{Kevin Middleton} (Co-PI), Carol Ward (co-PI)",
...
tribble(
  ...
  "2013-2018", "Amanda Smolinsky", "Ph.D. University of Missouri", "Currently an Assistant Professor at St. Norbert College",
...
tribble(
  ~ Dates, ~ Name, ~ Degree,
  "2023-Present", "Esdras Tuyshimire", "Ph.D.; Biologcal Sciences",
  ...
  "2018-Present", "Samuel Sullivan", "Ph.D.; Pathobiology",
  "2018-Present", "Austin Lawrence", "Ph.D.; Pathobiology",
...
tribble(
  ~ Dates, ~ Name, ~ Degree, ~ Notes,
  "2020-2022", "Gabriel Jacobs", "Ph.D.; Geological Sciences", "Currently lecturer, Cornell College",
  "2018-2022", "Sean Greer", "Ph.D.; Pathobiology", "Currently lecturer, University of Missouri",
  "2018-2022", "Emily Lessner", "Ph.D.; Pathobiology", "Currently at Petrified National Forest",
  "2016-2022", "Elizabeth Cho", "Ph.D.; Anthropology", "Currently postdoctoral researcher, UNTHSC",
  "2016-2021", "Deise Cruz", "Ph.D.; Biological Sciences", "",
  "2016-2021", "Kaleb Sellers", "Ph.D.; Pathobiology", "Currently postdoctoral researcher, University of Chicago",
  "2017-2021", "Faye McGechie", "Ph.D.; Pathobiology", "Currently postdoctoral researcher, University of Arizona",
  ...
  "2019-2020", "Mikaela Pulsipher", "M.S.; Geological Sciences", "Currently doctoral student at University of Missouri",
...
tribble(
  ~ Dates, ~ Name, ~ Notes,
  "2021-Present", "Adam Albright", "MU A&S Summer Scholar",
...
# Add
# AABA 2023: Steer, Fields, Lawrence
#
...
# Published Abstracts (most recent 50 of `r nrow(Abstracts)`)
...
tribble(
  ~ Dates, ~ Service,
  "2023-Present", "Division of Biological Sciences Graduate Faculty",
  "2022-Present", "DBS Graduate Education Committee",
