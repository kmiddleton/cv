...
tribble(~ Dates, ~ Title, ~ Agency, ~ PIs,
        ...
        "NIH NIDCR",
        "RJ Sherwood, D Duren, and KM Middleton (Multiple PI) \\\\ Lead data scientist; 25\\% salary support",
        "2022", 
        "Biomechanics of Grasping in Primates",
        "Leakey Foundation",
        "CV Ward, CM Holliday, and KM Middleton (co-PI) \\\\ \\$25,000"
) %>% 
  detailed_entries(when = Dates, what = Title, with = Agency,
...
tribble(~ Dates, ~ Title, ~ Agency, ~ PIs,
        ...
        "R01 - Craniofacial Growth Prediction in Diﬀerent Facial Types",
        "NIH NIDCR",
        "RJ Sherwood, HS Oh, \\textbf{Kevin Middleton} (Multiple PI) \\\\ Role: Lead data scientist (25\\% salary support)") %>% 
  detailed_entries(when = Dates, what = Title, with = Agency,
                   where = PIs, .protect = FALSE)
```
...
tribble(
  ...
  "2018-2022", "Emily Lessner", "Ph.D.; Pathobiology", "",
