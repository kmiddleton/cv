...
tribble(
  ...
  detailed_entries(when = Dates, what = Service, with = Publisher)
```
...
tribble(
  ...
  "2013-2016, 2019-2021", "SOM Summer Research Internship in Medical Sciences Selection Committee",
